...
Meteor.publish 'transcripts', (userId) ->
  ...
  return Transcript.documents.find {reviewCompletedOn:undefined}, {sort: {created:1, "pescCollegeTranscript.CollegeTranscript.TransmissionData.RequestTrackingID":1}}
